...
class CanonicalEvent(Base):
    ...
    action_reason = Column(String(length=256), nullable=True)
    tcp_flags = Column(String(length=64), nullable=True)
    inbound_interface = Column(String(length=128), nullable=True)
    outbound_interface = Column(String(length=128), nullable=True)
    inbound_zone = Column(String(length=128), index=True, nullable=True)
    outbound_zone = Column(String(length=128), nullable=True)
    source_fqdns = Column(JSON, nullable=True)
    destination_fqdns = Column(JSON, nullable=True)
    bytes = Column(Integer, nullable=True)
    packets = Column(Integer, nullable=True)
    duration_ms = Column(Integer, nullable=True)
    nat_type = Column(String(length=64), nullable=True)
    translated_src_ip = Column(String(length=64), nullable=True)
    translated_dst_ip = Column(String(length=64), nullable=True)
    translated_src_port = Column(Integer, nullable=True)
    translated_dst_port = Column(Integer, nullable=True)
